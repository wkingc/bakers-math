...
waimees_sandwich_bread <-
    new(
        ...
        4) Place the dough onto a lightly oiled surface and shape into a ball.  Oil a container and place the dough inside, turning to coat all sides.  Cover the container with a lid or plastic wrap and bulk ferment the dough until it has roughly doubled in size from the build up of gas (approx. 8-9 hours).
