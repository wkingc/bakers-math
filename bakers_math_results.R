...
#############################################
# Waimee's Levained Sandwich Bread (1.0 kg) #
#############################################
waimee_levain_sandwich_bread_1.0kg <-
    new(
        "bakersFormula",
...
waimee_levain_sandwich_bread_1.0kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water <- bakers_math(starter_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, waimee_levain_sandwich_bread_1.0kg)

save_kable(waimee_levain_sandwich_bread_1.0kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, file = "./formula/waimee_levain_sandwich_loaf_1.0kg.pdf")

waimee_levain_sandwich_bread_1.0kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water

###########################################
# Waimee's Levained Hearth Bread (1.0 kg) #
###########################################
waimee_levain_hearth_bread_1.0kg <-
    new(
        "bakersFormula",
...
waimee_levain_hearth_bread_1.0kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water <- bakers_math(starter_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, waimee_levain_hearth_bread_1.0kg)

save_kable(waimee_levain_hearth_bread_1.0kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, file = "./formula/waimees_levain_hearth_bread_1.0kg.pdf")

waimee_levain_hearth_bread_1.0kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water

###########################################
# Waimee's Levained Hearth Bread (0.5 kg) #
###########################################
waimee_levain_hearth_bread_0.5kg <-
    new(
        "bakersFormula",
        ...
        notes = 
         ...
         3) Bulk ferment the dough until it has doubled in volume (about 8 hours later in a 70-degree kitchen).  Build up the dough's gluten structure by performing four stretch-and-folds at 30 minute intervals during the bulk ferment's first two hours.
         4) After the bulk ferment, preshape the dough into two rounds with a slight amount of tension, and let them bench-rest for 15 minutes.
         5) Create one batard or boule (https://www.youtube.com/watch?v=O6INjgO91mg&t=130s) and place it seam-side up in seasoned proofing baskets.  Loosely cover it with plastic and let the dough proof overnight in the fridge for 12-15 hours.
         6) Preheat your cast-iron baking vessel (https://challengerbreadware.com/product/challenger-bread-pan/) in the oven for an hour at 500 degrees.  Place your proofed bread in the baking vessel and score.  If there is enough room without touching the bread, put in an ice cube or two for extra steam.
         7) Place the baking vessel in the oven and adjust to 435 degrees.  Bake for 15 minutes.
         8) After 15 minutes remove the baking vessel cover and bake for another 30 minutes, or until your desired crust color is achieved.")

waimee_levain_hearth_bread_0.5kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water <- bakers_math(starter_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, waimee_levain_hearth_bread_0.5kg)

save_kable(waimee_levain_hearth_bread_0.5kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, file = "./formula/waimee_levain_hearth_bread_0.5kg.pdf")

waimee_levain_hearth_bread_0.5kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water

#####################################################
# Waimee's Overnight Levained Hearth Bread (0.5 kg) #
#####################################################
waimee_overnight_levain_hearth_bread_0.5kg <-
    new(
        "bakersFormula",
        formula_name = "Waimee's Overnight Hearth Bread (0.5 kg)",
        total_flour_weight = 500,
        water_base_percent = 78,
        levain_base_percent = 6,
        flour_base_names = c("All purpose white flour", "Whole wheat flour"),
        flour_base_percent = c(90, 10),
        other_names = c("Fine sea salt"),
        other_percent = c(2.2),
        notes = 
            "1) Feed your starter in the morning and keep it at room temperatue (about 70 degrees) overnight.  In the afternoon it should have doubled in size from the build-up of gas.  If the starter smells like over-ripe fruit you will end up with a more buttery flavour.  If the starter goes longer, it will begin to have a vinergary smell, and the final loaf will be more sour.
         2) Mix the flour and 90-95 degree water in a tub and let it autolyse for about 30 minutes before incorporating the levain and salt.  The target temperature of the dough at the end of the final mix is 77-78 degrees. 
         3) Bulk ferment the dough until it has doubled in volume (about 13 hours later in a 70-degree kitchen).  Build up the dough's gluten structure by performing four stretch-and-folds at 30 minute intervals during the bulk ferment's first two hours.
         4) After the bulk ferment, preshape the dough into two rounds with a slight amount of tension, and let them bench-rest for 15 minutes.
         5) Create one batard or boule (https://www.youtube.com/watch?v=O6INjgO91mg&t=130s) and place it seam-side up in seasoned proofing baskets.  Loosely cover it with plastic and let the dough proof overnight in the fridge for 12-15 hours.
         6) Preheat your cast-iron baking vessel (https://challengerbreadware.com/product/challenger-bread-pan/) in the oven for an hour at 500 degrees.  Place your proofed bread in the baking vessel and score.  If there is enough room without touching the bread, put in an ice cube or two for extra steam.
         7) Place the baking vessel in the oven and adjust to 435 degrees.  Bake for 15 minutes.
...
waimee_overnight_levain_hearth_bread_0.5kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water <- bakers_math(starter_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, waimee_overnight_levain_hearth_bread_0.5kg)

save_kable(waimee_overnight_levain_hearth_bread_0.5kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water, file = "./formula/waimee_overnight_levain_hearth_bread_0.5kg.pdf")

waimee_overnight_levain_hearth_bread_0.5kg_1pt_mature_1.6pt_all_purpose_white_0.4pt_whole_wheat_2pt_water
