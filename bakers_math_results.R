...
waimees_sandwich_bread <-
    new(
        ...
        3) Incorporate the levain, butter, and dry ingredients into the autolysed dough using the mixing attachment of a stand mixer.  Switch to a dough hook and knead on medium speed until smooth and elastic, about 8-10 minutes.  
        4) Place the dough onto a lightly oiled surface and shape into a ball.  Oil the contained and place the dough inside, turning to coat all sides.  Cover the container with a lid or plastic wrap and bulk ferment the dough until it has roughly doubled in size from the build up of gas (approx. 8-9 hours).
