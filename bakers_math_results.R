...
waimee_levain_sandwich_bread <-
    new(
        ...
        3) Bulk ferment the dough until it has not quite doubled in volume.  Build up the dough's gluten structure by performing four stretch-and-folds at 30 minute intervals during the bulk ferment's first two hours. 
...
waimee_overnight_levain_hearth_bread <-
    new(
        ...
        notes = 
         ...
         8) After 20 minutes remove the baking vessel cover and bake for another 25 minutes, or until your desired crust color is achieved.")
