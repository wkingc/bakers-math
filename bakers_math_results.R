...
waimees_sandwich_bread <-
    new(
        ...
        2) Mix the wheat flours with 90-95 degree water in a tub and let the dough autolyse for about 30 minutes before incorporating the remaining ingredients.  Meanwhile, melt the butter and mix together the remaining dry ingredients. 
        3) Incorporate the levain, cooled butter, and dry ingredients into the autolysed dough using the pencer method (see https://www.youtube.com/watch?v=HoY7CPw0E1s).  The target temperature of the dough at the end of the final mix is 77-78 degrees. 
        4) Bulk ferment the dough until it has roughly doubled in size from the build up of gas (approx. 8-9 hours).  Build up the dough's gluten structure by performing four stretch-and-folds at 30 minute intervals during the bulk ferment's first two hours (see https://www.youtube.com/watch?v=CQHuWDEo3SA).
        5) After the bulk ferment, preshape the dough into a round with a slight amount of tension, and let it bench-rest for 15 minutes.  Afterward, flour the top of the dough, flip, and create a sausage-roll loaf with tension by pushing it back as you roll it (see https://www.youtube.com/watch?v=jIzKcred_lc).  Put the loaf seam-side down in a greased 2 lb loaf pan and loosely cover it (a disposable plastic shower cap works well!).
        ...
        7) Preheat your oven 350 degrees and bake the loaf for 35-40 minutes, tenting it with aluminum foil after 10-15 minutes if the top is browning too quickly.
